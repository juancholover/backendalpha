...
import upeu.edu.pe.academic.application.services.EstudianteApplicationService;
...
public class EstudianteController {
    ...
    @Inject
    EstudianteApplicationService estudianteService;
    ...
    @APIResponses(value = {
            @APIResponse(responseCode = "200", description = "Lista de estudiantes obtenida exitosamente", content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    })
    ...
    public Response findByCodigoEstudiante(
            @Parameter(description = "Código del estudiante", required = true) @PathParam("codigoEstudiante") String codigoEstudiante) {
    ...
    public Response findByProgramaAcademico(
            @Parameter(description = "ID del programa académico", required = true) @PathParam("programaId") Long programaId) {
    ...
    public Response findByEstadoAcademico(
            @Parameter(description = "Estado académico (ACTIVO, RETIRADO, EGRESADO, GRADUADO, LICENCIA)", required = true) @PathParam("estado") String estado) {
    ...
    public Response create(
            @Parameter(description = "Datos del estudiante a crear", required = true) @Valid EstudianteRequestDTO dto) {
    ...
    public Response update(
            @Parameter(description = "ID del estudiante", required = true) @PathParam("id") Long id,
            @Parameter(description = "Datos actualizados del estudiante", required = true) @Valid EstudianteRequestDTO dto) {
    ...
    public Response cambiarEstadoAcademico(
            @Parameter(description = "ID del estudiante", required = true) @PathParam("id") Long id,
            @Parameter(description = "Nuevo estado académico", required = true) @QueryParam("nuevoEstado") String nuevoEstado) {
