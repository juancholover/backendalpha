...
import upeu.edu.pe.academic.application.services.PersonaApplicationService;
...
public class PersonaController {
    ...
    @Inject
    PersonaApplicationService personaService;
    ...
    @APIResponses(value = {
            @APIResponse(responseCode = "200", description = "Persona encontrada", content = @Content(schema = @Schema(implementation = ApiResponse.class))),
            @APIResponse(responseCode = "404", description = "Persona no encontrada")
    })
    public Response findById(
            @Parameter(description = "ID de la persona", required = true) @PathParam("id") Long id) {
    ...
    public Response findByNumeroDocumento(
            @Parameter(description = "Número de documento", required = true) @PathParam("numeroDocumento") String numeroDocumento) {
    ...
    public Response findByEmail(
            @Parameter(description = "Email de la persona", required = true) @PathParam("email") String email) {
    ...
    public Response searchByNombres(
            @Parameter(description = "Término de búsqueda", required = true) @QueryParam("q") String searchTerm) {
    ...
    public Response create(
            @Parameter(description = "Datos de la persona a crear", required = true) @Valid PersonaRequestDTO dto) {
    ...
    public Response update(
            @Parameter(description = "ID de la persona", required = true) @PathParam("id") Long id,
            @Parameter(description = "Datos actualizados de la persona", required = true) @Valid PersonaRequestDTO dto) {
